            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text('• Fidya is ONLY for those permanently unable to fast', style: TextStyle(fontSize: 13)),
                  const SizedBox(height: 4),
                  const Text('• If you can make up fasts later, you must fast (Qadha)', style: TextStyle(fontSize: 13)),
                  const SizedBox(height: 4),
                  const Text('• Hanafi standard: 1.6kg wheat per missed fast', style: TextStyle(fontSize: 13)),
                  const SizedBox(height: 4),
                  const Text('• Can be given as food or monetary equivalent', style: TextStyle(fontSize: 13)),
                ],
              ),
            ),
          ),

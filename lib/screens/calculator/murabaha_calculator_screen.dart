      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 24),
            _ResultRow('Cost Price:', _result!.costPrice.toStringAsFixed(2)),
            const Divider(),
            _ResultRow('Profit:', _result!.profit.toStringAsFixed(2)),
            const Divider(),
            _ResultRow('Profit Percentage:', '${_result!.profitPercentage.toStringAsFixed(2)}%'),
            const Divider(),
            _ResultRow(
              'Total Selling Price:',
              _result!.sellingPrice.toStringAsFixed(2),
              highlight: true,
            ),
            const Divider(),
            ...
            _ResultRow(
              'Monthly Payment:',
              _result!.monthlyPayment.toStringAsFixed(2),
              highlight: true,
            ),
